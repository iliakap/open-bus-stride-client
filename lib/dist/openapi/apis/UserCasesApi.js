...
exports.UserCasesApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var UserCasesApi = /** @class */ (function (_super) {
    __extends(UserCasesApi, _super);
    function UserCasesApi() {
     ...
     * List
     */
    UserCasesApi.prototype.routeTimetableListGetRaw = function (requestParameters, initOverrides) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.plannedStartTimeDateFrom !== undefined) {
                            queryParameters['planned_start_time_date_from'] = requestParameters.plannedStartTimeDateFrom.toISOString();
                        }
                        if (requestParameters.plannedStartTimeDateTo !== undefined) {
                            queryParameters['planned_start_time_date_to'] = requestParameters.plannedStartTimeDateTo.toISOString();
                        }
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(models_1.RouteTimetablePydanticModelFromJSON); })];
                }
            });
        });
    };
     ...
     * List
     */
    UserCasesApi.prototype.routeTimetableListGet = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.routeTimetableListGetRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * List
     */
    UserCasesApi.prototype.stopArrivalsListGetRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(models_1.StopArrivalPydanticModelFromJSON); })];
                }
            });
        });
    };
     ...
     * List
     */
    UserCasesApi.prototype.stopArrivalsListGet = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.stopArrivalsListGetRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
...
exports.UserCasesApi = UserCasesApi;
