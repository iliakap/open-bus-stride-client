...
import type { RouteTimetablePydanticModel, StopArrivalPydanticModel } from '../models';
 ...
 *
 */
export declare class UserCasesApi extends runtime.BaseAPI {
    /**
     * List of the stops timetable of a given bus. Currently, only planned time (gtfs) is returned for every stop.
     * List
     */
    routeTimetableListGetRaw(requestParameters: RouteTimetableListGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<RouteTimetablePydanticModel>>>;
    /**
     * List of the stops timetable of a given bus. Currently, only planned time (gtfs) is returned for every stop.
     * List
     */
    routeTimetableListGet(requestParameters?: RouteTimetableListGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<RouteTimetablePydanticModel>>;
    /**
     * List of the actual arrival times to a specific stop. Currently, only planned time (gtfs) is returned for every stop.
     * List
     */
    stopArrivalsListGetRaw(requestParameters: StopArrivalsListGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<StopArrivalPydanticModel>>>;
    /**
     * List of the actual arrival times to a specific stop. Currently, only planned time (gtfs) is returned for every stop.
     * List
     */
    stopArrivalsListGet(requestParameters?: StopArrivalsListGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<StopArrivalPydanticModel>>;
}
