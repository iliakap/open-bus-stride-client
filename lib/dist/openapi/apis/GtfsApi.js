                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.gtfsStopDateFrom !== undefined) {
                            queryParameters['gtfs_stop__date_from'] = requestParameters.gtfsStopDateFrom.toISOString().substr(0, 10);
                        }
                        if (requestParameters.gtfsStopDateTo !== undefined) {
                            queryParameters['gtfs_stop__date_to'] = requestParameters.gtfsStopDateTo.toISOString().substr(0, 10);
                        }
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(models_1.GtfsRideStopWithRelatedPydanticModelFromJSON); })];
                }
            });
        });
    };
