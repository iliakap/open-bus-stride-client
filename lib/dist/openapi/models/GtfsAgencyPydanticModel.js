...
exports.GtfsAgencyPydanticModelToJSON = exports.GtfsAgencyPydanticModelFromJSONTyped = exports.GtfsAgencyPydanticModelFromJSON = exports.instanceOfGtfsAgencyPydanticModel = void 0;
/**
 * Check if a given object implements the GtfsAgencyPydanticModel interface.
 */
function instanceOfGtfsAgencyPydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfGtfsAgencyPydanticModel = instanceOfGtfsAgencyPydanticModel;
function GtfsAgencyPydanticModelFromJSON(json) {
    return GtfsAgencyPydanticModelFromJSONTyped(json, false);
}
exports.GtfsAgencyPydanticModelFromJSON = GtfsAgencyPydanticModelFromJSON;
function GtfsAgencyPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.GtfsAgencyPydanticModelFromJSONTyped = GtfsAgencyPydanticModelFromJSONTyped;
function GtfsAgencyPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GtfsAgencyPydanticModelToJSON = GtfsAgencyPydanticModelToJSON;
