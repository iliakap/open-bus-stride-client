 ...
 */
export declare function instanceOfSiriStopPydanticModel(value: object): boolean;
export declare function SiriStopPydanticModelFromJSON(json: any): SiriStopPydanticModel;
export declare function SiriStopPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriStopPydanticModel;
export declare function SiriStopPydanticModelToJSON(value?: SiriStopPydanticModel | null): any;
