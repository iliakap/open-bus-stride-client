...
exports.SiriStopPydanticModelToJSON = exports.SiriStopPydanticModelFromJSONTyped = exports.SiriStopPydanticModelFromJSON = exports.instanceOfSiriStopPydanticModel = void 0;
/**
 * Check if a given object implements the SiriStopPydanticModel interface.
 */
function instanceOfSiriStopPydanticModel(value) {
    var isInstance = true;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "code" in value;
    return isInstance;
}
exports.instanceOfSiriStopPydanticModel = instanceOfSiriStopPydanticModel;
function SiriStopPydanticModelFromJSON(json) {
    return SiriStopPydanticModelFromJSONTyped(json, false);
}
exports.SiriStopPydanticModelFromJSON = SiriStopPydanticModelFromJSON;
function SiriStopPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SiriStopPydanticModelFromJSONTyped = SiriStopPydanticModelFromJSONTyped;
function SiriStopPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SiriStopPydanticModelToJSON = SiriStopPydanticModelToJSON;
