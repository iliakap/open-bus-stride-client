 ...
 */
export declare function instanceOfSiriVehicleLocationPydanticModel(value: object): boolean;
export declare function SiriVehicleLocationPydanticModelFromJSON(json: any): SiriVehicleLocationPydanticModel;
export declare function SiriVehicleLocationPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriVehicleLocationPydanticModel;
export declare function SiriVehicleLocationPydanticModelToJSON(value?: SiriVehicleLocationPydanticModel | null): any;
