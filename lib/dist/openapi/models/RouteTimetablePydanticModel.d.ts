 ...
 */
export declare function instanceOfRouteTimetablePydanticModel(value: object): boolean;
export declare function RouteTimetablePydanticModelFromJSON(json: any): RouteTimetablePydanticModel;
export declare function RouteTimetablePydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteTimetablePydanticModel;
export declare function RouteTimetablePydanticModelToJSON(value?: RouteTimetablePydanticModel | null): any;
