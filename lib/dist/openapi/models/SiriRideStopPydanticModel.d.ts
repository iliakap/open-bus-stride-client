 ...
 */
export declare function instanceOfSiriRideStopPydanticModel(value: object): boolean;
export declare function SiriRideStopPydanticModelFromJSON(json: any): SiriRideStopPydanticModel;
export declare function SiriRideStopPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriRideStopPydanticModel;
export declare function SiriRideStopPydanticModelToJSON(value?: SiriRideStopPydanticModel | null): any;
