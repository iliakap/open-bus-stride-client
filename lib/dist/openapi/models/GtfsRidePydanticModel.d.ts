 ...
 */
export declare function instanceOfGtfsRidePydanticModel(value: object): boolean;
export declare function GtfsRidePydanticModelFromJSON(json: any): GtfsRidePydanticModel;
export declare function GtfsRidePydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GtfsRidePydanticModel;
export declare function GtfsRidePydanticModelToJSON(value?: GtfsRidePydanticModel | null): any;
