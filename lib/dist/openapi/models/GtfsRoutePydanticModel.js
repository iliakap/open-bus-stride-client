...
exports.GtfsRoutePydanticModelToJSON = exports.GtfsRoutePydanticModelFromJSONTyped = exports.GtfsRoutePydanticModelFromJSON = exports.instanceOfGtfsRoutePydanticModel = void 0;
var runtime_1 = require("../runtime");
/**
 * Check if a given object implements the GtfsRoutePydanticModel interface.
 */
function instanceOfGtfsRoutePydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfGtfsRoutePydanticModel = instanceOfGtfsRoutePydanticModel;
function GtfsRoutePydanticModelFromJSON(json) {
    return GtfsRoutePydanticModelFromJSONTyped(json, false);
}
exports.GtfsRoutePydanticModelFromJSON = GtfsRoutePydanticModelFromJSON;
function GtfsRoutePydanticModelFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'routeShortName': !(0, runtime_1.exists)(json, 'route_short_name') ? undefined : json['route_short_name'],
        'routeLongName': !(0, runtime_1.exists)(json, 'route_long_name') ? undefined : json['route_long_name'],
        'routeMkt': !(0, runtime_1.exists)(json, 'route_mkt') ? undefined : json['route_mkt'],
        'routeDirection': !(0, runtime_1.exists)(json, 'route_direction') ? undefined : json['route_direction'],
        'routeAlternative': !(0, runtime_1.exists)(json, 'route_alternative') ? undefined : json['route_alternative'],
        'agencyName': !(0, runtime_1.exists)(json, 'agency_name') ? undefined : json['agency_name'],
        'routeType': !(0, runtime_1.exists)(json, 'route_type') ? undefined : json['route_type'],
    };
}
exports.GtfsRoutePydanticModelFromJSONTyped = GtfsRoutePydanticModelFromJSONTyped;
function GtfsRoutePydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GtfsRoutePydanticModelToJSON = GtfsRoutePydanticModelToJSON;
