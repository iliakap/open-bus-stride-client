 ...
 */
export declare function instanceOfSiriSnapshotPydanticModel(value: object): boolean;
export declare function SiriSnapshotPydanticModelFromJSON(json: any): SiriSnapshotPydanticModel;
export declare function SiriSnapshotPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriSnapshotPydanticModel;
export declare function SiriSnapshotPydanticModelToJSON(value?: SiriSnapshotPydanticModel | null): any;
