...
exports.SiriVehicleLocationWithRelatedPydanticModelToJSON = exports.SiriVehicleLocationWithRelatedPydanticModelFromJSONTyped = exports.SiriVehicleLocationWithRelatedPydanticModelFromJSON = exports.instanceOfSiriVehicleLocationWithRelatedPydanticModel = void 0;
var runtime_1 = require("../runtime");
/**
 * Check if a given object implements the SiriVehicleLocationWithRelatedPydanticModel interface.
 */
function instanceOfSiriVehicleLocationWithRelatedPydanticModel(value) {
    var isInstance = true;
    return isInstance;
}
exports.instanceOfSiriVehicleLocationWithRelatedPydanticModel = instanceOfSiriVehicleLocationWithRelatedPydanticModel;
function SiriVehicleLocationWithRelatedPydanticModelFromJSON(json) {
    return SiriVehicleLocationWithRelatedPydanticModelFromJSONTyped(json, false);
}
exports.SiriVehicleLocationWithRelatedPydanticModelFromJSON = SiriVehicleLocationWithRelatedPydanticModelFromJSON;
function SiriVehicleLocationWithRelatedPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'id': !(0, runtime_1.exists)(json, 'id') ? undefined : json['id'],
        'siriSnapshotId': !(0, runtime_1.exists)(json, 'siri_snapshot_id') ? undefined : json['siri_snapshot_id'],
        'siriRideStopId': !(0, runtime_1.exists)(json, 'siri_ride_stop_id') ? undefined : json['siri_ride_stop_id'],
        'recordedAtTime': !(0, runtime_1.exists)(json, 'recorded_at_time') ? undefined : (new Date(json['recorded_at_time'])),
        'lon': !(0, runtime_1.exists)(json, 'lon') ? undefined : json['lon'],
        'lat': !(0, runtime_1.exists)(json, 'lat') ? undefined : json['lat'],
        'bearing': !(0, runtime_1.exists)(json, 'bearing') ? undefined : json['bearing'],
        'velocity': !(0, runtime_1.exists)(json, 'velocity') ? undefined : json['velocity'],
        'distanceFromJourneyStart': !(0, runtime_1.exists)(json, 'distance_from_journey_start') ? undefined : json['distance_from_journey_start'],
        'distanceFromSiriRideStopMeters': !(0, runtime_1.exists)(json, 'distance_from_siri_ride_stop_meters') ? undefined : json['distance_from_siri_ride_stop_meters'],
        'siriSnapshotSnapshotId': !(0, runtime_1.exists)(json, 'siri_snapshot__snapshot_id') ? undefined : json['siri_snapshot__snapshot_id'],
        'siriRouteId': !(0, runtime_1.exists)(json, 'siri_route__id') ? undefined : json['siri_route__id'],
        ...
        'siriRideId': !(0, runtime_1.exists)(json, 'siri_ride__id') ? undefined : json['siri_ride__id'],
...
exports.SiriVehicleLocationWithRelatedPydanticModelFromJSONTyped = SiriVehicleLocationWithRelatedPydanticModelFromJSONTyped;
function SiriVehicleLocationWithRelatedPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SiriVehicleLocationWithRelatedPydanticModelToJSON = SiriVehicleLocationWithRelatedPydanticModelToJSON;
