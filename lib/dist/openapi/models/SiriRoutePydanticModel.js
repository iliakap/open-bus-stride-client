...
exports.SiriRoutePydanticModelToJSON = exports.SiriRoutePydanticModelFromJSONTyped = exports.SiriRoutePydanticModelFromJSON = exports.instanceOfSiriRoutePydanticModel = void 0;
/**
 * Check if a given object implements the SiriRoutePydanticModel interface.
 */
function instanceOfSiriRoutePydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfSiriRoutePydanticModel = instanceOfSiriRoutePydanticModel;
function SiriRoutePydanticModelFromJSON(json) {
    return SiriRoutePydanticModelFromJSONTyped(json, false);
}
exports.SiriRoutePydanticModelFromJSON = SiriRoutePydanticModelFromJSON;
function SiriRoutePydanticModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SiriRoutePydanticModelFromJSONTyped = SiriRoutePydanticModelFromJSONTyped;
function SiriRoutePydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SiriRoutePydanticModelToJSON = SiriRoutePydanticModelToJSON;
