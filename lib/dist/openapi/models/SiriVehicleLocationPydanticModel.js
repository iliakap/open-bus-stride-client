...
exports.SiriVehicleLocationPydanticModelToJSON = exports.SiriVehicleLocationPydanticModelFromJSONTyped = exports.SiriVehicleLocationPydanticModelFromJSON = exports.instanceOfSiriVehicleLocationPydanticModel = void 0;
var runtime_1 = require("../runtime");
/**
 * Check if a given object implements the SiriVehicleLocationPydanticModel interface.
 */
function instanceOfSiriVehicleLocationPydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfSiriVehicleLocationPydanticModel = instanceOfSiriVehicleLocationPydanticModel;
function SiriVehicleLocationPydanticModelFromJSON(json) {
    return SiriVehicleLocationPydanticModelFromJSONTyped(json, false);
}
exports.SiriVehicleLocationPydanticModelFromJSON = SiriVehicleLocationPydanticModelFromJSON;
function SiriVehicleLocationPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SiriVehicleLocationPydanticModelFromJSONTyped = SiriVehicleLocationPydanticModelFromJSONTyped;
function SiriVehicleLocationPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SiriVehicleLocationPydanticModelToJSON = SiriVehicleLocationPydanticModelToJSON;
