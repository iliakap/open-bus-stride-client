 ...
 */
export declare function instanceOfGtfsStopPydanticModel(value: object): boolean;
export declare function GtfsStopPydanticModelFromJSON(json: any): GtfsStopPydanticModel;
export declare function GtfsStopPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GtfsStopPydanticModel;
export declare function GtfsStopPydanticModelToJSON(value?: GtfsStopPydanticModel | null): any;
