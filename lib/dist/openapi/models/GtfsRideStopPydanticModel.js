...
exports.GtfsRideStopPydanticModelToJSON = exports.GtfsRideStopPydanticModelFromJSONTyped = exports.GtfsRideStopPydanticModelFromJSON = exports.instanceOfGtfsRideStopPydanticModel = void 0;
var runtime_1 = require("../runtime");
/**
 * Check if a given object implements the GtfsRideStopPydanticModel interface.
 */
function instanceOfGtfsRideStopPydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfGtfsRideStopPydanticModel = instanceOfGtfsRideStopPydanticModel;
function GtfsRideStopPydanticModelFromJSON(json) {
    return GtfsRideStopPydanticModelFromJSONTyped(json, false);
}
exports.GtfsRideStopPydanticModelFromJSON = GtfsRideStopPydanticModelFromJSON;
function GtfsRideStopPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.GtfsRideStopPydanticModelFromJSONTyped = GtfsRideStopPydanticModelFromJSONTyped;
function GtfsRideStopPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GtfsRideStopPydanticModelToJSON = GtfsRideStopPydanticModelToJSON;
