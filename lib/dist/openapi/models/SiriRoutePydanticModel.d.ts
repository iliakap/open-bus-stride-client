 ...
 */
export declare function instanceOfSiriRoutePydanticModel(value: object): boolean;
export declare function SiriRoutePydanticModelFromJSON(json: any): SiriRoutePydanticModel;
export declare function SiriRoutePydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriRoutePydanticModel;
export declare function SiriRoutePydanticModelToJSON(value?: SiriRoutePydanticModel | null): any;
