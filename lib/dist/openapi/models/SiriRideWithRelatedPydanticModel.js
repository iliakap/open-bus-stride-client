...
function SiriRideWithRelatedPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'siriRouteLineRef': !(0, runtime_1.exists)(json, 'siri_route__line_ref') ? undefined : json['siri_route__line_ref'],
        'siriRouteOperatorRef': !(0, runtime_1.exists)(json, 'siri_route__operator_ref') ? undefined : json['siri_route__operator_ref'],
