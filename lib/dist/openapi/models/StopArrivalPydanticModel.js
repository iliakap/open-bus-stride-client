...
exports.StopArrivalPydanticModelToJSON = exports.StopArrivalPydanticModelFromJSONTyped = exports.StopArrivalPydanticModelFromJSON = exports.instanceOfStopArrivalPydanticModel = void 0;
var runtime_1 = require("../runtime");
/**
 * Check if a given object implements the StopArrivalPydanticModel interface.
 */
function instanceOfStopArrivalPydanticModel(value) {
    var isInstance = true;
    return isInstance;
}
exports.instanceOfStopArrivalPydanticModel = instanceOfStopArrivalPydanticModel;
function StopArrivalPydanticModelFromJSON(json) {
    return StopArrivalPydanticModelFromJSONTyped(json, false);
}
exports.StopArrivalPydanticModelFromJSON = StopArrivalPydanticModelFromJSON;
function StopArrivalPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'actualArrivalTime': !(0, runtime_1.exists)(json, 'actual_arrival_time') ? undefined : (new Date(json['actual_arrival_time'])),
    };
}
exports.StopArrivalPydanticModelFromJSONTyped = StopArrivalPydanticModelFromJSONTyped;
function StopArrivalPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.StopArrivalPydanticModelToJSON = StopArrivalPydanticModelToJSON;
