...
exports.GtfsRidesAggPydanticModelToJSON = exports.GtfsRidesAggPydanticModelFromJSONTyped = exports.GtfsRidesAggPydanticModelFromJSON = exports.instanceOfGtfsRidesAggPydanticModel = void 0;
/**
 * Check if a given object implements the GtfsRidesAggPydanticModel interface.
 */
function instanceOfGtfsRidesAggPydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfGtfsRidesAggPydanticModel = instanceOfGtfsRidesAggPydanticModel;
function GtfsRidesAggPydanticModelFromJSON(json) {
    return GtfsRidesAggPydanticModelFromJSONTyped(json, false);
}
exports.GtfsRidesAggPydanticModelFromJSON = GtfsRidesAggPydanticModelFromJSON;
function GtfsRidesAggPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
...
exports.GtfsRidesAggPydanticModelFromJSONTyped = GtfsRidesAggPydanticModelFromJSONTyped;
function GtfsRidesAggPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GtfsRidesAggPydanticModelToJSON = GtfsRidesAggPydanticModelToJSON;
