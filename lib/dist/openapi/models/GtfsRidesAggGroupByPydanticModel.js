...
exports.GtfsRidesAggGroupByPydanticModelToJSON = exports.GtfsRidesAggGroupByPydanticModelFromJSONTyped = exports.GtfsRidesAggGroupByPydanticModelFromJSON = exports.instanceOfGtfsRidesAggGroupByPydanticModel = void 0;
var runtime_1 = require("../runtime");
/**
 * Check if a given object implements the GtfsRidesAggGroupByPydanticModel interface.
 */
function instanceOfGtfsRidesAggGroupByPydanticModel(value) {
    var isInstance = true;
...
exports.instanceOfGtfsRidesAggGroupByPydanticModel = instanceOfGtfsRidesAggGroupByPydanticModel;
function GtfsRidesAggGroupByPydanticModelFromJSON(json) {
    return GtfsRidesAggGroupByPydanticModelFromJSONTyped(json, false);
}
exports.GtfsRidesAggGroupByPydanticModelFromJSON = GtfsRidesAggGroupByPydanticModelFromJSON;
function GtfsRidesAggGroupByPydanticModelFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'gtfsRouteDate': !(0, runtime_1.exists)(json, 'gtfs_route_date') ? undefined : (new Date(json['gtfs_route_date'])),
        'operatorRef': !(0, runtime_1.exists)(json, 'operator_ref') ? undefined : json['operator_ref'],
        'dayOfWeek': !(0, runtime_1.exists)(json, 'day_of_week') ? undefined : json['day_of_week'],
        'totalRoutes': json['total_routes'],
        'totalPlannedRides': json['total_planned_rides'],
        'totalActualRides': json['total_actual_rides'],
    };
}
exports.GtfsRidesAggGroupByPydanticModelFromJSONTyped = GtfsRidesAggGroupByPydanticModelFromJSONTyped;
function GtfsRidesAggGroupByPydanticModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GtfsRidesAggGroupByPydanticModelToJSON = GtfsRidesAggGroupByPydanticModelToJSON;
