 ...
 */
export declare function instanceOfSiriRidePydanticModel(value: object): boolean;
export declare function SiriRidePydanticModelFromJSON(json: any): SiriRidePydanticModel;
export declare function SiriRidePydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriRidePydanticModel;
export declare function SiriRidePydanticModelToJSON(value?: SiriRidePydanticModel | null): any;
