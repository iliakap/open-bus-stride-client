...
function HTTPValidationErrorFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'detail': !(0, runtime_1.exists)(json, 'detail') ? undefined : (json['detail'].map(ValidationError_1.ValidationErrorFromJSON)),
    };
}
...
function HTTPValidationErrorToJSON(value) {
    ...
    return {
        'detail': value.detail === undefined ? undefined : (value.detail.map(ValidationError_1.ValidationErrorToJSON)),
    };
}
