 ...
 */
export declare function instanceOfGtfsAgencyPydanticModel(value: object): boolean;
export declare function GtfsAgencyPydanticModelFromJSON(json: any): GtfsAgencyPydanticModel;
export declare function GtfsAgencyPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GtfsAgencyPydanticModel;
export declare function GtfsAgencyPydanticModelToJSON(value?: GtfsAgencyPydanticModel | null): any;
