 ...
 */
export function instanceOfSiriRoutePydanticModel(value: object): boolean {
    let isInstance = true;
...
export function SiriRoutePydanticModelFromJSON(json: any): SiriRoutePydanticModel {
    return SiriRoutePydanticModelFromJSONTyped(json, false);
}

export function SiriRoutePydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriRoutePydanticModel {
...
export function SiriRoutePydanticModelToJSON(value?: SiriRoutePydanticModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
