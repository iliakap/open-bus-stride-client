 ...
 */
export function instanceOfGtfsAgencyPydanticModel(value: object): boolean {
    let isInstance = true;
...
export function GtfsAgencyPydanticModelFromJSON(json: any): GtfsAgencyPydanticModel {
    return GtfsAgencyPydanticModelFromJSONTyped(json, false);
}

export function GtfsAgencyPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GtfsAgencyPydanticModel {
...
export function GtfsAgencyPydanticModelToJSON(value?: GtfsAgencyPydanticModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
