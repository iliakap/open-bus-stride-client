 ...
 */
export function instanceOfSiriRideStopPydanticModel(value: object): boolean {
    let isInstance = true;
...
export function SiriRideStopPydanticModelFromJSON(json: any): SiriRideStopPydanticModel {
    return SiriRideStopPydanticModelFromJSONTyped(json, false);
}

export function SiriRideStopPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiriRideStopPydanticModel {
...
export function SiriRideStopPydanticModelToJSON(value?: SiriRideStopPydanticModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
